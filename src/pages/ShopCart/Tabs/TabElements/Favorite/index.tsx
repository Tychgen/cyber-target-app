...
import { selectFavlist, removeFromFavlist } from '../../../../../store/slices/favouriteSlice';
...
const Favorite = () => {
 ...
 const FavedProducts = sortProducts(sortBy).filter((product) => {
  const FavedItem = favlist.find((item: {id:number} ) => item.id === product.id);
  return FavedItem && FavedItem.isFav 
});
                    ...
                    <hr />
                     <div className="d-flex justify-content-between align-items-center mb-4">
                      <div>
                        ...
                        <p className='h5 pt-3 mt-3 ps-'><span className='ps-4'>Your Favorite Items</span></p>
                      </div>
                    </div>

                    {FavedProducts.map((product) => (
                        ...
                        <div className="card-body">
                          <div className="d-flex justify-content-between">
                            <div className="d-flex flex-row align-items-center">
                              ...
                              <div className='pe-5 pt-5 me-4'>
                                <button className='remove h6 btn btn-outline-dark fs-6' onClick={() => dispatch(removeFromFavlist({id:product.id, isFav:!product.isFav}))}>Remove from Favorite List</button>
                              </div>
                            </div>
                            <div className="d-flex flex-row align-items-center">
