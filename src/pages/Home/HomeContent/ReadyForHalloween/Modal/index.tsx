...
interface ModalContentProps {
  ...
  const ModalContent: React.FC<ModalContentProps> = ({ isModalOpen, setIsModalOpen, selectedProduct }) => {
   ...
   <div>
        {selectedProduct && (
          <>
            ...
            <Button type='primary' className='ms-5' danger onClick={()=> navigate(`/product/${selectedProduct.id}`)}>Product's Page</Button>
